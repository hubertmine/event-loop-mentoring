...
var $timeout = (0, _symbol2.default)('timeout property');
...
var Logger = (_class = function (_Writable) {
	...
	(0, _createClass3.default)(Logger, [{
		key: '_write',
		value: function () {
			var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(log, enc, cb) {
				var conn;
		...
		key: $getConnection,
		value: function () {
			var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(_resolve, _reject) {
				var _this4 = this;
		...
		set: function set(val) {
			if ((0, _isInteger2.default)(val) && val >= 0) this[$timeout] = parseInt(val);
