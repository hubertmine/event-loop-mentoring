...
var bufferSize = exports.bufferSize = 100;

var host = exports.host = 'data.logentries.com';

var maxFailedAttempts = exports.maxFailedAttempts = 15;

var port = exports.port = 80;

var portSecure = exports.portSecure = 443;

var retryTimeout = exports.retryTimeout = 15 * 60 * 1000;

var timeout = exports.timeout = 3 * 60 * 1000;
